...
for ($i = 1; $i < strlen($per_subject_question); $i++) {
	...
	<div id="box">
		...
		<div id="questionBox" onclick="selectOption(this)"></div>
		<div id="optionBox">
			<div class="op" type="textarea" name="o1" id="o1"    onclick="selectOption(this)"></div><br>
			<div class="op" type="textarea" name="o2" id="o2"    onclick="selectOption(this)"></div><br>
			<div class="op" type="textarea" name="o3" id="o3"    onclick="selectOption(this)"></div><br>
			<div class="op" type="textarea" name="o4" id="o4"    onclick="selectOption(this)"></div><br>
		</div>
	</div>
		<div id="entry">
		<b>Paragraph:</b><br>
		<textarea rows ="2" cols ="15" name="para" id ="para" placeholder="Insert a Paragraph"></textarea><br>
		<button id="a" onclick="addPara()">add Paragraph</button><br><br>
		<b>Fraction:</b><br>
	...
	<script type="text/javascript">
		document.getElementById(subjects[selected_subject]).style.backgroundColor="green";
		document.getElementById('nqs').innerHTML=parseInt(num_ques_subject[selected_subject]) +1;
		function changeSubject(subject){
			document.getElementById(subjects[selected_subject]).style.backgroundColor="red";
